...
Список приложений стандартный. Это *Будильник*, *Мировое время*, *Фонарик*, приложение для передачи файлов через Bluetooth. На вкладка *i-zone* также есть встроенный браузер. 
